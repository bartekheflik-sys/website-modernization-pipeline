...
/**
 * A lightweight mock of class-variance-authority (cva)
 * This allows the UI to render even if the package is missing.
 */
...
/**
 * A lightweight mock of @radix-ui/react-slot
 */
