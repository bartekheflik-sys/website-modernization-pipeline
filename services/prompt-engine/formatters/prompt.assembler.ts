...
export function generateLovablePrompt(analysis: AIAnalysisOutput): GeneratedPromptOutput {
  ...
  const sections = [
    ...
    buildGlobalInstructions(analysis),
...
Generated by AI Website Modernization Platform
==================================================
